 ...
 */
(function(a){a.fn.animateEach=function(g,k,h){var e=0,c=this,f=c.length,j,b;b=a.extend({},a.fn.animateEach.defaults,k);h=h||(typeof k==="function"?k:a.noop);(function d(){j=c.eq(e);b.before.call(j);j.animate(g,b.duration,function(){if(e<f){b.after.call(j);d()}else{h.call(c)}});e++})();return this};a.fn.animateEach.defaults={duration:300,before:a.noop,after:a.noop}}(jQuery));